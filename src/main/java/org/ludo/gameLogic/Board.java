...
public abstract class Board {
  ...
  final public static ArrayList<BoardPosition> goalPositions = new ArrayList<>();
...
//    Short up
  ...
  private static void generateGoalPositions() {
    for (int i = 0; i < colorOrder.length; i++) {
      BoardPosition penultimate = homeColumnPositions.get(i * 6 + 4);
      BoardPosition last = homeColumnPositions.get(i * 6 + 5);
